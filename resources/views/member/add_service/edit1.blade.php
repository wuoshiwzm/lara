 ...
 <div class="result_wrap">
			 ...
			 <div class="result_content">
					 <div class="short_wrap">
						 <a href="{{url('member/article1/create')}}"><i class="fa fa-plus"></i>添加文章</a>
						 <a href="{{url('member/article1')}}"><i class="fa fa-refresh"></i>全部文章</a>
					 </div>
			 </div>
	 </div>
	 <!--结果集标题与导航组件 结束-->
	 ...
	 <div class="result_wrap">
			 <form action="{{url('member/article1/'.$field->art_id)}}" method="post">
