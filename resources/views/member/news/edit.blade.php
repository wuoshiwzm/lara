...
@section('content')
 ...
 <div class="result_wrap">
	 ...
	 <div class="result_wrap">
			 <form action="{{url('member/news/'.$news->news_id)}}" method="post">
							 ...
							 <tbody>
								 ...
								 <tr>
									...
									<tr>
											 ...
											 <script id="editor" name="news_content" type="text/plain" style="width:860px;height:350px;">{!!$news->news_content!!}</script>
