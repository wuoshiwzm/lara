        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{url('admin/offer/create')}}"><i class="fa fa-plus"></i>新增求购</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
            ...
            <div class="result_content">
                <table class="list_tab">
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/offer/'.$v->offer_id.'/edit')}}">修改</a>
...
function delOffer(offer_id){
	...
	layer.confirm('是否删除分类？', {
	  btn: ['确认','取消']
			...
			$.post("{{url('admin/offer/')}}/"+offer_id,{'_method':'delete','_token':"{{csrf_token()}}"},function(data){
				if(data.status==0){
