...
@section('content')
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="#" ><i class="fa fa-plus"></i>发布信息</a>
                <a href="#" ><i class="fa fa-suitcase"></i>自媒体管理</a>
                <a href="#" ><i class="fa fa-tags"></i>帐户充值</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>北京时间</label><span><?php echo date('Y年m月d日 - H时i分s秒',strtotime('+1 hours')) ?></span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://adbangbang.com</a></span>
                </li>
                <li>
