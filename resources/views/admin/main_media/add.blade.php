...
@section('content')
 ...
 <!--结果集标题与导航组件 开始-->
	 ...
	 <div class="result_wrap">
			 <form action="{{url('admin/main_media')}}" method="post">
					 ...
					 <table class="add_tab">
							 <tbody>
									 ...
									 <tr>
											 ...
											 <td>
													 <input type="text" name="main_media_name">
									 ...
									 <tr>
											 ...
											 <td>
													 <input type="text" class="md" name="main_media_en">
											 </td>
									 </tr>
									 ...
									 <tr>
											<th>排序：</th>
											<td>
													<input type="text" class="sm" name="main_media_order" value="0">
											</td>
									</tr>
