...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/mpic')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="mpic_name">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="md" name="mpic_url">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" size="50" name="mpic_path">
                ...
                <tr>
                    <th>排序：</th>
                    <td>
                        <input type="text" class="sm" name="mpic_order" value="0">
                    </td>
                </tr>
