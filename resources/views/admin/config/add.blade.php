...
@section('content')
	 ...
	 <div class="crumb_warp">
			 ...
			 <i class="fa fa-home"></i> <a href="{{url('admin/config')}}">首页</a> &raquo; 配置项管理
							 ...
							 <tbody>
								 ...
								 <tr>
									 ...
									 <tr>
											...
											<td>
													<input type ="radio" type="text" name="field_type" value="input" checked onclick="showTr()">input　　
													<input type ="radio" type="text" name="field_type" value="radio" onclick="showTr()">radio　　
													<input type ="radio" type="text" name="field_type" value="textarea" onclick="showTr()">textarea　	　
									 ...
									 <tr>
											 ...
											 <td>
													 <textarea type="text" name="conf_tips"></textarea>
											 </td>
										 </tr>
