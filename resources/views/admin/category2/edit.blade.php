...
@section('content')
	 ...
	 <div class="crumb_warp">
			 ...
			 <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">编辑分类</a>
 ...
 <div class="result_wrap">
			 ...
			 <div class="result_content">
					 <div class="short_wrap">
						 ...
						 <a href="{{url('admin/category2')}}"><i class="fa fa-refresh"></i>全部分类</a>
					 </div>
			 </div>
	 </div>
	 <!--结果集标题与导航组件 结束-->
	 ...
	 <div class="result_wrap">
			 <form action="{{url('admin/category2/'.$field->cate_id)}}" method="post">
