							 ...
							 <tbody>
								 ...
								 <tr>
										...
										<td>
											...
											<input type="checkbox" name="art_type" value="全程代理">全程代理
											<input type="checkbox" name="art_type" value="策划代理">策划代理
											<input type="checkbox" name="art_type" value="销售代理">销售代理
											<input type="checkbox" name="art_type" value="其他">其他
										</td>
								</tr>
								<tr>
									<th>public_价格(元)：</th>
