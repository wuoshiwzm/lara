							 ...
							 <tbody>
								 ...
								 <tr>
										...
										<td>
											上限为五个...
											<hr>
											<input type="checkbox" name="art_type" value="开盘活动">开盘活动
											<input type="checkbox" name="art_type" value="开工仪式">开工仪式
											<input type="checkbox" name="art_type" value="上市活动">上市活动
											<input type="checkbox" name="art_type" value="周年庆典">周年庆典
											<input type="checkbox" name="art_type" value="开幕仪式">开幕仪式
											<input type="checkbox" name="art_type" value="竣工仪式">竣工仪式
											<input type="checkbox" name="art_type" value="开园仪式">开园仪式
											<input type="checkbox" name="art_type" value="封顶仪式">封顶仪式
											<input type="checkbox" name="art_type" value="暖场仪式">暖场仪式
											<input type="checkbox" name="art_type" value="节庆仪式">节庆仪式
											<input type="checkbox" name="art_type" value="颁奖仪式">颁奖仪式
