    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                ...
                <a href="{{url('admin/news')}}"><i class="fa fa-refresh"></i>全部新闻</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
        ...
        <form action="{{url('admin/news/'.$news->news_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th> 新闻标题：</th>
                    <td>
                        <input type="text" class="lg" name="news_editor" value="{{$news->news_editor}}">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" name="news_content" type="text/plain"
