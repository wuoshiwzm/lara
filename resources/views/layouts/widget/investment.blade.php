<div class="box4">
                ...
                @if(isset($news))
                    @foreach($news as $k => $v)
                        @if($k == 0)
                            ...
                            <div class="con_left">
                                <a href="{{url('news/'.$v->news_id)}}"><img src="images/image1.jpg"/></a>
                    ...
                    @if(isset($news))
                        @foreach($news as $k => $v)
                            <div class="li_con">
                                ...
                                <div class="squ"></div>
                                <div class="li_conrg">
                                    <p class="li_title"><a href="{{url('news/'.$v->news_id)}}">{{$v->news_title}}...</a><span>2016-05-04</span></p>
    ...
    <div class="box4_right">
        ...
        <div id="con_lefa_1" class="display" style="display: block;">
            ...
            <div class="conr_top">
                <a href="{{url('offer/'.$offer[0]->offer_id)}}"><img src="images/image1.jpg"/></a>
                <p class="paa">
