        ...
        <div class="title_right">
             <ul>
                 @foreach($recm1 as $k => $r)
                    <li class="@if($k == 0) hover @endif" id="cehua{{$k+1}}" onMouseover="setTab('cehua',{{$k+1}},4)">{{array_keys($r)[0]}}<a href="#">
                      </a></li>
                 @endforeach
                    <a href="{{url('cate')}}" target="_blank"><img src="{{asset('resources/views/home/images/more.jpg')}}" alt="" /></a>
            </ul>
        </div>
    </div>
    <div class="box3_cone">
      @foreach($recm1 as $k => $v)
        <div id="con_cehua_{{$k+1}}" class="@if($k == 0) display @else hidden  @endif" style="display: @if($k == 0) block @else none  @endif;">
                                  ...
                                  <!-- 文章循环 -->
                                    ...
                                    <ul>
                                      ...
                                      <?php //dd($arts); ?>
                                        ...
                                        <li>
                                            <a href="{{url('a1/'.$arts->art_id)}}"><img src="{{asset($arts->art_thumb)}}" /></a>
                                            <div class="bto-gu">
