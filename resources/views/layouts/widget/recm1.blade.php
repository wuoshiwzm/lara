<div class="box3">
    ...
    <div class="box3_title">
        <div class="title_left"><a href="">设计与策划服务 <span>/</span></a><span class="small">Design & Activity</span></div>
        <div class="title_right">
             <ul>
               @foreach($recm1 as $k => $r)
                  <li class="@if($k == 0) hover @endif" id="tuijian{{$k+1}}" onMouseover="setTab('tuijian',{{$k+1}},4)">{{array_keys($r)[0]}}<a href="#">
                    </a></li>
               @endforeach
