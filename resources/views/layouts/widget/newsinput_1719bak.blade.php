...
<div class="kuang">
    ...
    <script type="text/javascript">
        var ue = UE.getEditor('editor',{
            toolbars: [
                ...
                ['fontfamily', 'fontsize', 'inserttable', 'horizontal', '|', 'emotion', 'insertimage', '|', 'imageleft', 'imagecenter', 'imageright']
            ]
        });
    </script>
    ...
    <div class="ku_bot">
        ...
        <br>
        <tr for="name">
            <th><input type="checkbox" name="contenttype" id="contenttype" value="1" />场景内容：</th>
            <td>
                <div id="cjurlcon" style="display:none;">
                    <input type="text" style="width:50%;height: 25px;border: 1px #a9a9a9 solid;" name="cate_cjurl" id="cjurl" placeholder="请输入生成的广告场景地址" />&nbsp;&nbsp;@if($userstatus!='0')<a href="http://cj.adbangbang.com/#/scene" target="_blank">去创建一个新广告场景>></a>@endif
                </div>
            </td>
        </tr>
        <br>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("input[name='contenttype']").click(function(){
            var chkres = $("input[type='checkbox']").is(':checked');
            if(!chkres)
            {
                $("#cjurlcon").hide();
            }
