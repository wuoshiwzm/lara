...
class WxHongBaoHelper
{
	...
	function setParameter($parameter, $parameterValue) {
		//trimString check if the value is empty, if it is empty,which means strlen($value)==0, change the value to null
		//push the key=>value into array $parameter[]
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT,dirname(__FILE__).DIRECTORY_SEPARATOR.'certification'.DIRECTORY_SEPARATOR.'apiclient_cert.pem');
 		curl_setopt($ch,CURLOPT_SSLKEY,dirname(__FILE__).DIRECTORY_SEPARATOR.'certification'.DIRECTORY_SEPARATOR.'apiclient_key.pem');
 		curl_setopt($ch,CURLOPT_CAINFO,dirname(__FILE__).DIRECTORY_SEPARATOR.'certification'.DIRECTORY_SEPARATOR.'rootca.pem');
